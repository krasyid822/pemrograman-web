...
<body>
    <div class="rectangle-1" id="home">
        ...
        <div style="color:white; position: absolute; right: 10px; top:20px;">
            <button onclick="window.location.href='#about'" style="border: 2px solid #FFA845E5; background: white;">Contact us</button>_<bc class="line-1-in-1"></bc>_<button onclick="window.location.href='login.php'" style="border: 2px solid #FFA845E5; background: white;">Login</button>
        </div>
    </div>
